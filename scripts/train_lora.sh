...
data_path="/home/star/8t_2/anyi.cjt/datasets/Cakeify-Dataset/data.json"
...
accelerate launch --config_file config/accelerate_no_deepspeed_single_gpu_5.yaml src/trainers/train_i2v_lora.py \
