...
class Trainer(BaseTrainer):
    ...
    def _init_noise_scheduler(self):
        ...
        noise_scheduler = ShiftedLogitNormTimestepSampler(
    ...
    def prepare_dataset(self):
        ...
        sampler = RepeatLastBatchSampler(
            train_dataset, 
        ...
        for epoch in range(first_epoch, self.args.num_train_epochs):
            ...
            for step, batch in enumerate(self.train_dataloader):
                ...
                if self.accelerator.sync_gradients:
                    ...
                    if global_step % self.args.validation_epochs == 0 :
    ...
    def compute_loss(self, batch, vae_stream):
        ...
        pixel_latents = self.encode_video(pixel_values, vae_stream, self.vae, self.args.vae_mini_batch, self.weight_dtype)
